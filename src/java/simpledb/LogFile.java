            ...
            synchronized (this) {
                ...
                if (checkpointOffset != NO_CHECKPOINT_ID) {
                    ...
                    for (int i = 0; i < size; ++i) {
                        Long logRecordTid = raf.readLong();
                        Long firstLogRecordOffset = raf.readLong();
                        tidToFirstLogRecord.put(logRecordTid, firstLogRecordOffset);
                    }
                    raf.readLong();
                }
                currentOffset = raf.getFilePointer();
...
//                                System.out.println("Here");
                    ...
                    System.out.println("this " + this + "current offset: " + currentOffset + ", length : " + raf.length() + "< count: " + counter);
                    throw e;
                }
            }
        }
